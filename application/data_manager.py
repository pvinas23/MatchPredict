...
TEAM_SVG_MAP = {
    ...
    'LIV': 'liverpool.svg',
    'MCI': 'machester_city.svg',  # Note: filename has typo in original file
...
def get_full_team_name(abbreviation):
    # And the other way round: abbreviation to full team name
    return ABBREVIATION_TO_TEAM.get(abbreviation, abbreviation)

def get_next_matches(limit=4):
    # Pull the upcoming fixtures for the season
    csv_route = Path(__file__).resolve().parent / "data" / "reference" / "fixtures_2026-27.csv"
